...
class Transformer_decoder(nn.Module):
    ...
    def forward(self, src, query_embed, extra_input=None, additional_pos_embed=None, pos_embed=None):
        # extra_input: num_tokens, bs, dim
...
def build_transformer_decoder(args):
    return Transformer_decoder(
        ...
        nhead=args.nheads,
        num_decoder_layers=args.dec_layers,
        use_pos_embd_image=True,
        use_pos_embd_action=True,
